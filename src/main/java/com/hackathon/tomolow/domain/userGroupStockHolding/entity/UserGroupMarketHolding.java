...
@AllArgsConstructor
@Table(
    name = "user_group_stock_holding",
    uniqueConstraints = {
        @UniqueConstraint(
            name = "uk_usergroup_stock",
            columnNames = {"usergroup_id", "stock_id"})
    })
public class UserGroupStockHolding extends BaseTimeEntity {
