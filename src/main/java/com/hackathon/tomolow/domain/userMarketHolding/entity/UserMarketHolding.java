package com.hackathon.tomolow.domain.userMarketHolding.entity;
...
@AllArgsConstructor
@Table(name = "user_market_holding")
public class UserMarketHolding extends BaseTimeEntity {
  ...
  private Market market; // 주식 (Stock FK)
