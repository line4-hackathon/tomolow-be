package com.hackathon.tomolow.global.s3.service;
...
import com.hackathon.tomolow.global.config.S3Config;
import com.hackathon.tomolow.global.exception.CustomException;
import com.hackathon.tomolow.global.s3.dto.S3Response;
import com.hackathon.tomolow.global.s3.entity.PathName;
import com.hackathon.tomolow.global.s3.exception.S3ErrorCode;
...
public class S3Service {
  ...
  public String createKeyName(PathName pathName) {
    ...
    return switch (pathName) {
          case STOCK -> s3Config.getStockPath();
